...
export class ApiRelationalDataAdapter
  ...
  async delete(
    ...
    return this.send(
      axios.post(`${this.baseUrl}/${schema.migrationId}/delete/${tableName}`, {
        where: filter,
      }),
    );
  }
  ...
  async insert(
    ...
    return this.send(
      axios.post(`${this.baseUrl}/${schema.migrationId}/insert/${tableName}`, {
        data,
      }),
    );
  }
  ...
  async update(
    ...
    return this.send(
      axios.post(`${this.baseUrl}/${schema.migrationId}/update/${tableName}`, {
        set: data,
        where: filter,
      }),
    );
