...
import { all, and, asc, count, desc, equal, isIn, notEqual } from '../../sql/function';
...
describe('select', () => {
  ...
  it('should select where with single and condition', () => {
    ...
    }, 'SELECT "auth"."user"."id" FROM "auth"."user" WHERE ("auth"."user"."id" = $1)', ['a']);
  });
  ...
  it('should select where with multiple and conditions', () => {
    ...
    }, 'SELECT "auth"."user"."id" FROM "auth"."user" WHERE ("auth"."user"."id" = $1 AND "auth"."user"."name" = $1)', ['a']);
  });
  ...
  it('should select where with in', () => {
    ...
    }, 'SELECT "auth"."user"."id" FROM "auth"."user" WHERE "auth"."user"."id" IN ($1, $2)', ['a', 'b']);
  });
