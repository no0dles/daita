...
export class RelationalAdapterMock implements RelationalTransactionAdapter {
  ...
  raw(sql: SqlSelect | SqlDelete | SqlUpdate | SqlInsert): Promise<RelationalRawResult>;
  ...
  expect(sqlOrResult: string | SqlQuery | RelationalRawResult, valuesOrResult?: any[] | RelationalRawResult, result?: RelationalRawResult): void {
