...
export class DatabaseSchemaTable<TField extends RelationalTableSchemaTableField = RelationalTableSchemaTableField,
  TReferenceField extends RelationalTableSchemaTableReferenceKey = RelationalTableSchemaTableReferenceKey> implements RelationalTableSchemaTable {
  constructor(
    public name: string,
