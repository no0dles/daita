...
export interface RelationalTransactionAdapterFactory
  extends RelationalAdapterFactory {
  createTransactionAdapter(
    options?: CreateAdapterOptions,
  ): Promise<RelationalTransactionAdapter>;
}

export const isRelationalTransactionAdapterFactory = (
  val: any,
): val is RelationalTransactionAdapterFactory =>
  isKind(val, ['createTransactionAdapter', 'destroy']);
