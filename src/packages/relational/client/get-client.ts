...
export function getClient<T>(dataAdapter: RelationalTransactionAdapter<T>): TransactionClient<Client<T>> & Client<T>
export function getClient<T>(dataAdapter: RelationalDataAdapter<T>): Client<T>
export function getClient<T>(dataAdapter: RelationalDataAdapter<T> | RelationalTransactionAdapter<T>): Client<T> | TransactionClient<Client<T>> {
