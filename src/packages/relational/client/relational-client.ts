...
import { isMaxDescription } from '../sql/function/aggregation/max-description';
import { isAvgDescription } from '../sql/function/aggregation/avg-description';
import { isSumDescription } from '../sql/function/aggregation/sum-description';
import { isCountDescription } from '../sql/function/aggregation/count-description';
import { isNowDescription } from '../sql/function/date/now-description';
import { RelationalRawResult } from '../adapter/relational-raw-result';
import { isConcatDescription } from '../sql/function/string/concat-description';
...
import { isMinDescription } from '../sql/function/aggregation/min-description';
